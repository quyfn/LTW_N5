...
urlpatterns = [
    ...
    path(
        'quan-ly/lich-hen/<int:booking_id>/cap-nhat-trang-thai/',
        views.api_update_booking_status,
        name='api_update_booking_status'
    ),
    path('quan-ly/phan-hoi/', feedback_dashboard, name='feedback_dashboard'),
    path(
        'quan-ly/phan-hoi/tu-van/',
        views.consultation_dashboard,
        name='consultation_dashboard'
    ),
    path(
        'quan-ly/phan-hoi/tu-van/<int:room_id>/',
    ...
    # Legacy (giá»¯ Ä‘á»ƒ trÃ¡nh lá»—i template cÅ©)
